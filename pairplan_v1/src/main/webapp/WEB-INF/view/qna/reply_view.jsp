	          ...
	          <div class="col-md-8">
	            <div class="row">
	              ...
	              <h2 class="text-center"><span><i class="fa fa-question-circle fa-2x" aria-hidden="true"></i></span> QnA</h2>
					...
					<input type="hidden" name="qna_group" value="${article.qna_group}">
					<input type="hidden" name="qna_step" value="${article.qna_step}">
					<input type="hidden" name="qna_pass" value="${article.qna_pass}"> <!-- 비밀번호 -->
		                  <div class="panel-body">
	                    	<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> &nbsp;<%=today%> &nbsp; &nbsp; &nbsp;
	                    	<span class="glyphicon glyphicon-globe" aria-hidden="true"></span> &nbsp;<%=ip%>
		                  </div>
		                  <table class="table">
		                    <tbody>
		                      <tr>
		                      ...
		                      <tr>
		                        ...
		                        <td>
		                          <div class="col-sm-6">
		                            <input type="text" class="form-control" id="qna_title" name="qna_title" value="Re: 문의하신 질문에 대한 답변입니다.">
		                          </div>
		                        </td>
		                      </tr>
		                      ...
		                      <tr>
		                        ...
		                        <td>
		                          <div class="col-sm-12">
		                            <textarea class="form-control" id="qna_cont" name="qna_cont" rows="6" placeholder="Insert Content"></textarea>
		                          </div>
		                        </td>
		                      </tr>
		                    </tbody>
		                  ...
		                  <div class="panel-body">
		                    <div class="row text-right">
		                      <div class="col-md-12">
		                        ...
		                        <button type="submit" class="btn btn-success">Reply <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></button>
		                      </div>
		                    </div>
		                  </div>
	                </form>
