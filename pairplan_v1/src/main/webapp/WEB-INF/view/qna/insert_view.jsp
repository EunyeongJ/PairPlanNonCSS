...
<html lang="en">
  <head>
	...
	<title>PairPlan | Write QnA</title>
              	...
              	<form action="qnaInsert" method="post">
	                  ...
	                  <table class="table">
	                    <tbody>
	                      ...
	                      <tr>
	                        <th scope="row">
	                          <label for="qna_pass" class="control-label">Password</label>
	                        </th>
	                        <td>
	                          <div class="col-sm-3">
	                      ...
	                      <tr>
	                        ...
	                        <td>
	                          <div class="col-sm-6">
	                            <input type="text" class="form-control" id="qna_title" name="qna_title" placeholder="Article Subject">
	                          </div>
	                        </td>
	                      </tr>
	                  ...
	                  <div class="panel-body">
	                    <div class="row text-right">
	                      <div class="col-md-12">
	                        ...
	                        <button type="submit" class="btn btn-primary">Write <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
	                      </div>
	                    </div>
	                  </div>
                </form>
