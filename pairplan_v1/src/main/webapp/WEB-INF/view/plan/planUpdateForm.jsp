...
<html lang="en">
  <head>
    ...
    <title>PairPlan | Write Plan</title>
...
<body>
	...
	<div class="page">
		...
		<div class="avt-post-wrapper section">
			<div class="container">
				<div class="avt-post">
					<form name="insertform" id="insertform" onsubmit="return locationInfoSet()" action="../update" method="post" enctype="multipart/form-data">
					<input type="hidden" name="plan_num" value="${plan.plan_num}">
					...
					<input type="hidden" name="mem_num" value="${sessionScope.session_mem_num}">
							<div class="seller-option avtpost-fields">
								<div class="row">
									<div class="col-md-12">
										<h3>Make Your Plan <span style="color: #02743a;">What kind of travel do you want?</span></h3>
									</div>
				                  <div class="col-md-6">
				                    <div class="post-inner">
				                      <div class="row form-group">
				                        ...
				                        <div class="col-md-8">
				                          <input type="text" required="required" class="form-control" name="plan_title" id="text" value="${plan.plan_title}" placeholder="Plan Title Go There" style="background-color:#f7f7f7">
				                        </div>
				                      </div>
				                    </div><!-- post-inner -->
				                    <div class="post-inner select-cat">
				                      <div class="row form-group">
				                        ...
				                        <div class="col-md-8">
				                          <select name="plan_people" id="plan_people" class="form-control" style="background-color:#f7f7f7">
				                    ...
				                    <div class="post-inner">
				                      <div class="row form-group">
				                        ...
				                        <div class="col-md-8">
				                          <textarea class="form-control" required="required" name="plan_cont" id="textarea" placeholder="Write details about your plan" rows="6" style="background-color:#f7f7f7">${plan.plan_cont}</textarea>
				                        </div>
				                      </div>
				                    </div><!-- post-inner -->
				                  </div>
				                  <div class="col-md-6">
				                    <div class="post-inner">
				                      <div class="row form-group">
				                        <label class="col-md-4">Plan Image :	</label>
				                        
				                        <div class="col-md-8">
				                            <img src="${pageContext.request.contextPath}/resources/images${plan.plan_img}" id="thumbnailImage" style="width:100%; height:270px; border-radius:6px;">
				                            <jsp:useBean id="random" class="java.util.Random" scope="application" />	<!-- 랜덤사용 -->
				                            <div style="float:right;">
									           <button id="deletethumbnail" type="button" class="close" aria-label="Close" onclick="imageDelete(${random.nextInt(2)});"><i class="fa fa-times fa-1x"></i></button>
									        </div>	
				                        </div>
				                      </div>
				                    </div><!-- post-inner -->
				                        ...
				                        <div class="col-md-8">
				                          <div class="upload-section">
				                            <label class="upload-image" for="uploadOne">
				                              ...
				                              <input type="hidden" id="plan_img" name="plan_img" value="${pageContext.request.contextPath}/resources/images${plan.plan_img}">
				                            </label>
				                          </div>
				                        </div>
				                      </div>
				                ...
				                <div class="row">
					                ...
					                <div class="col-md-12">
					                <c:forEach var="plan_allStyle" items="${plan_allStyle}">
							        	<c:if test="${plan_allStyle.plan_num==0}">
							        		<label class="checkbox-inline" style="padding-right:5px;">
						                      <input type="checkbox" name="plan_style" value="${plan_allStyle.style_num}"> ${plan_allStyle.style_name}
						                    </label>
							        	</c:if>
							        	<c:if test="${plan_allStyle.plan_num!=0}">
							        		<label class="checkbox-inline" style="padding-right:5px;">
						                      <input type="checkbox" name="plan_style" value="${plan_allStyle.style_num}" checked="checked"> ${plan_allStyle.style_name}
						                    </label>
							        	</c:if>
							        </c:forEach>
					                </div>
							...
							<div class="blog-content blog-detail">
				                <div class="blog-post">
				                  <div class="entry-content" style="border: 1px solid #ddd; padding-top: 25px; border-radius: 4px;">
									...
									<p class="text-right"><i class="fa fa-clock-o"></i> Today: <fmt:formatDate value="${plan.plan_date }" type="date"/></p>
	...
	$(function(){
	  ...
	  setBounds();                  //지도 범위 재설정   
	  	...
	  	//셀렉트 박스 초기화
	    var plan_people = ${plan.plan_people};
		$("#plan_people").val(plan_people).attr("selected", "selected");	
		$("#plan_people").attr("disabled","disabled");
	});
	</script>
  </body>
</html>
